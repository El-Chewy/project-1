...
function clickClr(){
    ...
    function clickEql(){
        if(!checkOperator()){
            ...
            let numbers = elem.innerHTML.match(re2);
    ...
    let division = (indexOfDiv != 0 ? parseInt(numbers[indexOfDiv -1],2) : parseInt(numbers[IndOfDiv],2) / parseInt(numbers[indexOfDiv +1],2);
        ...
        let sum = (indexOfSum != 0 ? parseInt(numbers[indexOfSum-1],2)) + parseInt(numbers[indexOfSum+1],2);
